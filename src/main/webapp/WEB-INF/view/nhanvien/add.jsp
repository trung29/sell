...
<br>
<div class="container">
    <form style="width: 50%;margin-left: 24%;" action="/nhanvien-save" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label>Role</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="role" value="Quản lý" id="flexRadioDefault5" disabled>
                <label class="form-check-label" for="flexRadioDefault1">
                    Quản lý
                </label>
            </div>
